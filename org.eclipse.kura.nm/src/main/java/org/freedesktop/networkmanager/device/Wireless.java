...
@DBusProperty(name = "Bitrate", type = UInt32.class, access = Access.READ)
@DBusProperty(name = "AccessPoints", type = Wireless.PropertyAccessPointsType.class, access = Access.READ)
@DBusProperty(name = "ActiveAccessPoint", type = DBusPath.class, access = Access.READ)
@DBusProperty(name = "WirelessCapabilities", type = UInt32.class, access = Access.READ)
