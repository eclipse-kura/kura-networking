...
public enum SupportedUsbModemInfo {
    ...
    Telit_HE910_DG(
            ...
            Arrays.asList(new UsbModemDriver("cdc_acm", "1bc7", "0021")),
            "6 CDC-ACM"),
    Telit_HE910_D(
            "HE910-D",
            "1bc7",
    ...
    Telit_GE910(
            ...
            5000,
            10000,
            Arrays.asList(ModemTechnologyType.GSM_GPRS),
    ...
    Telit_LE910(
            ...
            5000,
            30000,
            Arrays.asList(ModemTechnologyType.LTE, ModemTechnologyType.HSPA, ModemTechnologyType.UMTS),
            Arrays.asList(new Le910ModemDriver()),
            ""),
    Telit_LE910_V2(
            "LE910-V2",
            "1bc7",
            ...
            10000,
            Arrays.asList(ModemTechnologyType.LTE, ModemTechnologyType.HSPA, ModemTechnologyType.UMTS),
            Arrays.asList(new UsbModemDriver("cdc_acm", "1bc7", "0036")),
            ""),
    Telit_CE910_DUAL(
            "CE910-DUAL",
            "1bc7",
            ...
            Arrays.asList(new Ce910ModemDriver()),
            ""),
    Sierra_MC8775(
            "MC8775",
            "1199",
    ...
    Sierra_MC8790(
            ...
            10000,
            Arrays.asList(ModemTechnologyType.HSDPA),
            Arrays.asList(new UsbModemDriver("sierra", "1199", "683c")),
            ""),
    Sierra_USB598(
            "USB598",
            "1199",
            ...
            Arrays.asList(new UsbModemDriver("sierra", "1199", "0025")),
            ""),
    Ublox_SARA_U2(
            "SARA-U2",
            "1546",
            ...
            5000,
            10000,
            Arrays.asList(ModemTechnologyType.HSPA),
            Arrays.asList(new UsbModemDriver("cdc_acm", "1546", "1102")),
            ""),
    UBLOX_LARA_R2(
            "LARA-R2",
            "1546",
            ...
            10000,
            Arrays.asList(ModemTechnologyType.LTE, ModemTechnologyType.HSPA, ModemTechnologyType.UMTS),
            Arrays.asList(new UsbModemDriver("cdc_acm", "1546", "110a")),
            ""),
    Zte_ME3630(
            "ME3630",
            "19d2",
            ...
            5000,
            10000,
            Arrays.asList(ModemTechnologyType.LTE, ModemTechnologyType.GSM_GPRS, ModemTechnologyType.UMTS),
            Arrays.asList(new OptionModemDriver("19d2", "1476")),
            ""),
    SimTech_SIM7000(
            "SIM7000",
            "1e0e",
            ...
            5000,
            10000,
            Arrays.asList(ModemTechnologyType.LTE, ModemTechnologyType.GSM_GPRS),
            Arrays.asList(new OptionModemDriver("1e0e", "9001")),
            ""),
    QUECTEL_EX25(
            "EX25",
            "2c7c",
    ...
    QUECTEL_BG96(
            ...
            10000,
            Arrays.asList(ModemTechnologyType.LTE, ModemTechnologyType.GSM_GPRS),
            Arrays.asList(new UsbModemDriver("cdc_acm", "2c7c", "0296")),
            ""),
    HUAWEI_MS2372(
            "MS2372",
            "12d1",
            ...
            15000,
            Arrays.asList(
                    ModemTechnologyType.LTE,
                    ModemTechnologyType.HSPA,
                    ModemTechnologyType.HSDPA,
                    ModemTechnologyType.UMTS,
                    ModemTechnologyType.GSM_GPRS),
            Arrays.asList(new UsbModemDriver("option", "12d1", "1506")),
            ""),
    TELEFONICA_IK41VE(
            "IK41VE",
            "1bbb",
            ...
            Arrays.asList(
                    ...
                    ModemTechnologyType.UMTS,
                    ModemTechnologyType.GSM_GPRS),
            Arrays.asList(new UsbModemDriver("option", "1bbb", "00b6")),
            "");
    ...
    private SupportedUsbModemInfo(
            ...
            long turnOffDelay,
            long turnOnDelay,
            List<ModemTechnologyType> modemTechnology,
            List<? extends UsbModemDriver> drivers,
            String prodName) {
