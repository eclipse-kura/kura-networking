...
public class NetworkConfigurationServiceCommon {
    ...
    public static Tocd getDefinition(Map<String, Object> properties, Optional<List<UsbNetDevice>> usbNetDevices)
        ...
        Tad tad = builder(NET_INTERFACES, NetworkConfigurationPropertyNames.PLATFORM_INTERFACES, Tscalar.STRING)
            ...
            for (String ifaceName : networkInterfaceNames) {
                ...
                switch (type.get()) {
                    case LOOPBACK:
                        ...
                        break;
                    case ETHERNET:
                        usbNetDevices.ifPresent(usbNetDevice -> getUsbDeviceDefinition(usbNetDevice, tocd, ifaceName));
    ...
    public static ComponentConfiguration getConfiguration(
            final String pid, final Map<String, Object> properties, final Optional<List<UsbNetDevice>> usbNetDevices)
            throws KuraException {
    ...
    private static void getModemDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_ENABLED,
                        Tscalar.BOOLEAN)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_ENABLED_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.username", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_USERNAME,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.password", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_PASSWORD,
                        Tscalar.PASSWORD)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.pdpType", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_PDP_TYPE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_MODEM_PDP_TYPE_VALUE.name())
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.maxFail", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_MAX_FAIL,
                        Tscalar.INTEGER)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_MAXFAIL_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.authType", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_AUTH_TYPE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_MODEM_AUTH_TYPE_VALUE.name())
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.lpcEchoInterval", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_LPC_ECHO_INTERVAL,
                        Tscalar.INTEGER)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_LPC_ECHO_FAILURE,
                        Tscalar.INTEGER)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_DIVERSITY_ENABLED,
                        Tscalar.BOOLEAN)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_RESET_TIMEOUT,
                        Tscalar.INTEGER)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_RESET_TIMEOUT_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.gpsEnabled", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_GPS_ENABLED,
                        Tscalar.BOOLEAN)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_GPS_ENABLED_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.persist", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_PERSIST,
                        Tscalar.BOOLEAN)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_PERSIST_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.apn", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_APN,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.dialString", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_DIAL_STRING,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.holdoff", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_HOLDOFF,
                        Tscalar.INTEGER)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_HOLDOFF_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.pppNum", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_MODEM_PPP_NUM,
                        Tscalar.INTEGER)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_MODEM_PPP_NUMBER_VALUE))
                .build());
    }
    ...
    private static void getWifiMasterDefinition(Tocd tocd, String ifaceName) {
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_SSID,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.broadcast", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_BROADCAST_ENABLED,
                        Tscalar.BOOLEAN)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_WIFI_BROADCAST_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.radioMode", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_RADIO_MODE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_RADIO_MODE_VALUE.name())
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.securityType", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_SECURITY_TYPE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_SECURITY_VALUE.name())
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.passphrase", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_PASSPHRASE,
                        Tscalar.PASSWORD)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.channel", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_CHANNEL,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_CHANNEL_VALUE)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.ignoreSSID", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_IGNORE_SSID,
                        Tscalar.BOOLEAN)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_PAIRWISE_CIPHERS,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_PAIRWISE_CIPHERS_VALUE.name())
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.master.groupCiphers", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MASTER_GROUP_CIPHERS,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_GROUP_CIPHERS_VALUE.name())
                .build());
    }
    ...
    private static void getWifiInfraDefinition(Tocd tocd, String ifaceName) {
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_SSID,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.infra.radioMode", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_RADIO_MODE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_RADIO_MODE_VALUE.name())
                .build());
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_SECURITY_TYPE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_SECURITY_VALUE.name())
                .build());
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_PASSPHRASE,
                        Tscalar.PASSWORD)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.infra.pairwiseCiphers", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_PAIRWISE_CIPHERS,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_PAIRWISE_CIPHERS_VALUE.name())
                .build());
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_GROUP_CIPHERS,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_GROUP_CIPHERS_VALUE.name())
                .build());
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_CHANNEL,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_CHANNEL_VALUE)
                .build());
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_BGSCAN,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_BGSCAN_VALUE)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.infra.pingAccessPoint", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_PING_AP,
                        Tscalar.BOOLEAN)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_WIFI_PING_AP_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.infra.ignoreSSID", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_INFRA_IGNORE_SSID,
                        Tscalar.BOOLEAN)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_WIFI_IGNORE_SSID_VALUE))
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.802-1x.password", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_802_1X_PASSWORD,
                        Tscalar.PASSWORD)
                .build());
    }
    ...
    private static void getWifiCommonDefinition(Tocd tocd, String ifaceName) {
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.WIFI_CAPABILITIES,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.wifi.mode", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_WIFI_MODE,
                        Tscalar.STRING)
                .withDefault(NetworkConfigurationConstants.DEFAULT_WIFI_MODE.name())
                .build());
    }
    ...
    private static void getIp4DnsDefinition(Tocd tocd, String ifaceName) {
        // DNS and WINS
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip4.dnsServers", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DNS_SERVERS,
                        Tscalar.STRING)
                .withCardinality(10000)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip4.winsServers", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_WINS_SERVERS,
                        Tscalar.STRING)
                .withCardinality(10000)
                .build());
    }
    ...
    private static void getIp6DnsDefinition(Tocd tocd, String ifaceName) {
        // DNS
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.dnsServers", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_DNS_SERVERS,
                        Tscalar.STRING)
                .withCardinality(10000)
                .build());
    }
    ...
    private static void getDhcpServerDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_ENABLED,
                        Tscalar.BOOLEAN)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_DEFAULT_LEASE_TIME,
                        Tscalar.INTEGER)
                .withDefault(
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_MAX_LEASE_TIME,
                        Tscalar.INTEGER)
                .withDefault(
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_PREFIX,
                        Tscalar.SHORT)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_RANGE_START,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.dhcpServer4.rangeEnd", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_RANGE_END,
                        Tscalar.STRING)
                .build());

        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.dhcpServer4.passDns", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_PASS_DNS,
                        Tscalar.BOOLEAN)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_SERVER_NAT_ENABLED,
                        Tscalar.BOOLEAN)
    ...
    private static void getVlanDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.vlan.parent", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_VLAN_PARENT,
                        Tscalar.STRING)
                .withRequired(true)
                .build());
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.vlan.id", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_VLAN_ID,
                        Tscalar.INTEGER)
                .withRequired(true)
                .build());
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.vlan.ingress", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_VLAN_INGRESS_MAP,
                        Tscalar.STRING)
                .build());
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.vlan.egress", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_VLAN_EGRESS_MAP,
                        Tscalar.STRING)
                .build());
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.vlan.flags", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_VLAN_FLAGS,
                        Tscalar.INTEGER)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_VLAN_FLAGS_VALUE))
                .build());
    }
    ...
    private static void addIp4InterfaceCommonDefinition(Tocd tocd, String ifaceName) {
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_DHCP_CLIENT_ENABLED,
                        Tscalar.BOOLEAN)
                .withRequired(true)
        ...
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_GATEWAY,
                        Tscalar.STRING)
                .build());
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip4.mtu", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_MTU,
                        Tscalar.INTEGER)
                .build());
    ...
    private static void addIp6InterfaceCommonDefinition(Tocd tocd, String ifaceName) {
        ...
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.address.method", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_ADDRESS_METHOD,
                        Tscalar.STRING)
                .withRequired(true)
                .withDefault(NetworkConfigurationConstants.DEFAULT_IPV6_ADDRESS_METHOD_VALUE)
                .build());
        ...
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.gateway", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_GATEWAY,
                        Tscalar.STRING)
                .build());
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.mtu", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_MTU,
                        Tscalar.INTEGER)
                .build());
        addIp4StatusDefinition(tocd, ifaceName);
    }
    ...
    private static void addIp6AddressGenerationModeDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.addr.gen.mode", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_ADDRESS_GENERATION_METHOD,
                        Tscalar.STRING)
                .build());
    }
    ...
    private static void addIp6PrivacyDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.privacy", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_PRIVACY,
                        Tscalar.STRING)
                .build());
    }
    ...
    private static void addTypeDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_TYPE,
                        Tscalar.STRING)
                .withRequired(true)
                .withDefault(NetworkConfigurationConstants.DEFAULT_INTERFACE_TYPE_VALUE.name())
                .build());
    }
    ...
    private static void addIp4StatusDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_STATUS,
                        Tscalar.STRING)
                .withRequired(true)
                .withDefault(NetworkConfigurationConstants.DEFAULT_IPV4_STATUS_VALUE.name())
                .build());
    }

    private static void addIp6StatusDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.status", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_STATUS,
                        Tscalar.STRING)
                .withRequired(true)
                .withDefault(NetworkConfigurationConstants.DEFAULT_IPV6_STATUS_VALUE.name())
                .build());
    }
    ...
    private static void addAutoconnectDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_AUTOCONNECT,
                        Tscalar.BOOLEAN)
                .withRequired(true)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_AUTOCONNECT_VALUE))
                .build());
    }
    ...
    private static void addMtuDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_MTU,
                        Tscalar.INTEGER)
                .build());
    }
    ...
    private static void addPromiscDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.promisc", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_PROMISC,
                        Tscalar.INTEGER)
                .withRequired(true)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_PROMISC_VALUE))
                .build());
    }
    ...
    private static void addIp4PrefixDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_PREFIX,
                        Tscalar.SHORT)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_IPV4_PREFIX_VALUE))
                .build());
    }

    private static void addIp6PrefixDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.prefix", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_PREFIX,
                        Tscalar.SHORT)
                .withDefault(String.valueOf(NetworkConfigurationConstants.DEFAULT_IPV6_PREFIX_VALUE))
                .build());
    }
    ...
    private static void addIp4AddressDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        ...
                        NetworkConfigurationPropertyNames.CONFIG_IPV4_ADDRESS,
                        Tscalar.STRING)
                .build());
    }
    ...
    private static void addIp6AddressDefinition(Tocd tocd, String ifaceName) {
        tocd.addAD(builder(
                        String.format(PREFIX + "%s.config.ip6.address", ifaceName),
                        NetworkConfigurationPropertyNames.CONFIG_IPV6_ADDRESS,
                        Tscalar.STRING)
                .build());
    }
    ...
    private static void getUsbDeviceDefinition(List<UsbNetDevice> usbNetDevices, Tocd tocd, String ifaceName) {
        if (usbNetDevices != null) {
            Optional<UsbNetDevice> usbNetDeviceOptional = usbNetDevices.stream()
                    .filter(usbNetDevice -> usbNetDevice.getInterfaceName().equals(ifaceName))
                    .findFirst();
            if (usbNetDeviceOptional.isPresent()) {
                tocd.addAD(builder(
                                String.format(PREFIX + "%s.usb.port", ifaceName),
                                NetworkConfigurationPropertyNames.USB_PORT,
                                Tscalar.STRING)
                        .build());

                tocd.addAD(builder(
                                String.format(PREFIX + "%s.usb.manufacturer", ifaceName),
                                NetworkConfigurationPropertyNames.USB_MANUFACTURER,
                                Tscalar.STRING)
                        .build());

                tocd.addAD(builder(
                                String.format(PREFIX + "%s.usb.product", ifaceName),
                                NetworkConfigurationPropertyNames.USB_PRODUCT,
                                Tscalar.STRING)
                        .build());

                tocd.addAD(builder(
                                String.format(PREFIX + "%s.usb.manufacturer.id", ifaceName),
                                NetworkConfigurationPropertyNames.USB_MANUFACTURER_ID,
                                Tscalar.STRING)
                        .build());

                tocd.addAD(builder(
                                String.format(PREFIX + "%s.usb.product.id", ifaceName),
                                NetworkConfigurationPropertyNames.USB_PRODUCT_ID,
                                Tscalar.STRING)
                        .build());
            }
        }
    ...
    public static Set<String> getNetworkInterfaceNamesInConfig(final Map<String, Object> properties) {
        return Optional.ofNullable(properties)
                .map(p -> p.get(NET_INTERFACES))
                .map(s -> COMMA.splitAsStream((String) s)
                        .filter(p -> !p.trim().isEmpty())
                        .collect(Collectors.toCollection(HashSet::new)))
                .orElseGet(HashSet::new);
    }

    public static Optional<NetInterfaceType> getNetworkTypeFromProperties(
            final String interfaceName, final Map<String, Object> properties) {
    ...
    public static Set<String> getIp6WanInterfacesInConfig(final Map<String, Object> properties) {
        return getNetworkInterfaceNamesInConfig(properties).stream()
                .filter(p -> NetInterfaceStatus.netIPv6StatusEnabledWAN
                        .name()
