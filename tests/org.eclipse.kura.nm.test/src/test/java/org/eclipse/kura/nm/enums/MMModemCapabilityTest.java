...
public class MMModemCapabilityTest {
    ...
    public static class MMModemCapabilityToModemCapabilitiesFromBitMaskTest {
        ...
        public static Collection<Object[]> ModemCapabilityParams() {
            ...
            params.add(new Object[] {new UInt32(0x00000003L), EnumSet.of(ModemCapability.POTS, ModemCapability.EVDO)});
            params.add(
                    new Object[] {new UInt32(0x00000006L), EnumSet.of(ModemCapability.EVDO, ModemCapability.GSM_UMTS)});
            params.add(new Object[] {new UInt32(0x00000004L), EnumSet.of(ModemCapability.GSM_UMTS)});
            params.add(new Object[] {
                new UInt32(0x0000000FL),
                EnumSet.of(ModemCapability.POTS, ModemCapability.EVDO, ModemCapability.GSM_UMTS, ModemCapability.LTE)
            });
        ...
        public MMModemCapabilityToModemCapabilitiesFromBitMaskTest(
                UInt32 intValue, Set<ModemCapability> modemCapability) {
            this.inputIntValue = intValue;
            this.expectedModemCapability = modemCapability;
        }
