...
public class NMDeviceStateReasonTest {
    ...
    public static class fromUInt32Test {
        ...
        public static Collection<Object[]> NMDeviceStateReasonParams() {
            ...
            params.add(new Object[] {new UInt32(5), NMDeviceStateReason.NM_DEVICE_STATE_REASON_IP_CONFIG_UNAVAILABLE});
            ...
            params.add(new Object[] {new UInt32(8), NMDeviceStateReason.NM_DEVICE_STATE_REASON_SUPPLICANT_DISCONNECT});
            params.add(
                    new Object[] {new UInt32(9), NMDeviceStateReason.NM_DEVICE_STATE_REASON_SUPPLICANT_CONFIG_FAILED});
            ...
            params.add(new Object[] {
                new UInt32(30), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_REGISTRATION_NOT_SEARCHING
            });
            params.add(
                    new Object[] {new UInt32(31), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_REGISTRATION_DENIED});
            params.add(
                    new Object[] {new UInt32(32), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_REGISTRATION_TIMEOUT});
            params.add(
                    new Object[] {new UInt32(33), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_REGISTRATION_FAILED});
            params.add(new Object[] {new UInt32(34), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_PIN_CHECK_FAILED});
            ...
            params.add(new Object[] {new UInt32(42), NMDeviceStateReason.NM_DEVICE_STATE_REASON_SUPPLICANT_AVAILABLE});
            ...
            params.add(new Object[] {new UInt32(45), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_SIM_NOT_INSERTED});
            params.add(new Object[] {new UInt32(46), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_SIM_PIN_REQUIRED});
            params.add(new Object[] {new UInt32(47), NMDeviceStateReason.NM_DEVICE_STATE_REASON_GSM_SIM_PUK_REQUIRED});
            ...
            params.add(
                    new Object[] {new UInt32(52), NMDeviceStateReason.NM_DEVICE_STATE_REASON_MODEM_MANAGER_UNAVAILABLE
                    });
            params.add(new Object[] {new UInt32(53), NMDeviceStateReason.NM_DEVICE_STATE_REASON_SSID_NOT_FOUND});
            params.add(
                    new Object[] {new UInt32(54), NMDeviceStateReason.NM_DEVICE_STATE_REASON_SECONDARY_CONNECTION_FAILED
                    });
            params.add(new Object[] {new UInt32(55), NMDeviceStateReason.NM_DEVICE_STATE_REASON_DCB_FCOE_FAILED});
            params.add(new Object[] {new UInt32(56), NMDeviceStateReason.NM_DEVICE_STATE_REASON_TEAMD_CONTROL_FAILED});
            ...
            params.add(new Object[] {new UInt32(64), NMDeviceStateReason.NM_DEVICE_STATE_REASON_IP_ADDRESS_DUPLICATE});
            params.add(new Object[] {new UInt32(65), NMDeviceStateReason.NM_DEVICE_STATE_REASON_IP_METHOD_UNSUPPORTED});
            params.add(
                    new Object[] {new UInt32(66), NMDeviceStateReason.NM_DEVICE_STATE_REASON_SRIOV_CONFIGURATION_FAILED
                    });
