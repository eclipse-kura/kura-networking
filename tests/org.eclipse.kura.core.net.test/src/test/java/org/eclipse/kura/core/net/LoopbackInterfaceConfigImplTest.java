...
public class LoopbackInterfaceConfigImplTest {
    ...
    public void testToString2() throws UnknownHostException {
        ...
        String expected =
                "name=loopbackInterface :: hardwareAddress=12:34:56:78:90:AB :: loopback=true :: pointToPoint=true"
    ...
    LoopbackInterfaceConfigImpl createConfig(int noOfAddresses) throws UnknownHostException {
        LoopbackInterfaceImpl<NetInterfaceAddressConfigImpl> interfaceImpl =
                new LoopbackInterfaceImpl<NetInterfaceAddressConfigImpl>("loopbackInterface");
