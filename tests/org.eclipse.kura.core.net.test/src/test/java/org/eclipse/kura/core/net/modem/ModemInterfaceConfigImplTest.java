...
public class ModemInterfaceConfigImplTest {
    ...
    public void testToString2() throws UnknownHostException {
        ...
        String expected =
                "name=ModemInterface :: hardwareAddress=12:34:56:78:90:AB :: loopback=true :: pointToPoint=true"
    ...
    public void testModemDevice() {
        ...
        UsbModemDevice modemDevice1 = new UsbModemDevice(
                "vendorId1", "productId1", "manufacturerName1", "productName1", "usbBusNumber1", "usbDevicePath1");
        config.setModemDevice(modemDevice1);
        assertEquals(modemDevice1, config.getModemDevice());

        UsbModemDevice modemDevice2 = new UsbModemDevice(
                "vendorId2", "productId2", "manufacturerName2", "productName2", "usbBusNumber2", "usbDevicePath2");
    ...
    ModemInterfaceConfigImpl createConfig(int noOfAddresses) throws UnknownHostException {
        ModemInterfaceImpl<ModemInterfaceAddressConfigImpl> interfaceImpl = new ModemInterfaceImpl<>("ModemInterface");
