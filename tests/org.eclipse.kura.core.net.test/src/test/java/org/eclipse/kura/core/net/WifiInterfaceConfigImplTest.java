...
public class WifiInterfaceConfigImplTest {
    ...
    public void testToString2() throws UnknownHostException {
        ...
        String expected =
                "name=wifiInterface :: hardwareAddress=12:34:56:78:90:AB :: loopback=true :: pointToPoint=true"
    ...
    WifiInterfaceConfigImpl createConfig(int noOfAddresses) throws UnknownHostException {
        WifiInterfaceImpl<WifiInterfaceAddressConfigImpl> interfaceImpl = new WifiInterfaceImpl<>("wifiInterface");
